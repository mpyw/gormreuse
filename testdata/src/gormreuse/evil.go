...
// =============================================================================
// SHOULD NOT REPORT - Mutually-exclusive branches are safe
// =============================================================================
...
func loopAssignmentOnly(db *gorm.DB, items []int) {
	...
	for _, item := range items {
		q = q.Where("item", item)  // Assignment only, no finisher
	}
...
func loopConditionalAssignment(db *gorm.DB, flags []bool) {
	...
	for _, flag := range flags {
		if flag {
			q = q.Where("flagged")  // Conditional assignment
		}
		// Phi created here
	}
...
// =============================================================================
// SHOULD NOT REPORT - Switch case branches are mutually exclusive
// =============================================================================
...
// =============================================================================
// SHOULD REPORT - Pure factory function (directive misapplied + return is mutable)
// =============================================================================

// pureFactoryFunction is a pure function that returns a new *gorm.DB without
// taking *gorm.DB as argument. This simulates a DB factory/wrapper. The
// directive itself is unused because the function takes no *gorm.DB
// argument to protect.
//
...
// =============================================================================
// SHOULD NOT REPORT - Safe variant (Session at root)
// =============================================================================
...
// =============================================================================
// =============================================================================
// SHOULD NOT REPORT - HIGHER-ORDER HELPERS
// =============================================================================
...
// =============================================================================
// SHOULD NOT REPORT - Struct field storage without use
// =============================================================================
...
// =============================================================================
// SHOULD NOT REPORT - Bound method on non-finisher (single use)
// =============================================================================
...
// =============================================================================
// SHOULD REPORT - EVIL PATTERNS - Method Values on chain methods
// =============================================================================
...
// =============================================================================
// =============================================================================
// SHOULD NOT REPORT - HELPER FUNCTIONS
// =============================================================================
...
// =============================================================================
// =============================================================================
// SHOULD NOT REPORT - IIFE returning Session() (Safe)
// =============================================================================
...
// =============================================================================
// =============================================================================
// SHOULD NOT REPORT - Begin() result is immutable
// =============================================================================
...
// =============================================================================
// SHOULD NOT REPORT - Reassignment per iteration is safe
// =============================================================================
...
// =============================================================================
// SHOULD NOT REPORT - Reassignment in both branches
// =============================================================================
...
// =============================================================================
// SHOULD NOT REPORT - Reassignment after nil clears state
// =============================================================================
...
// =============================================================================
// SHOULD NOT REPORT - Final reassignment yields fresh root
// =============================================================================
...
// =============================================================================
// SHOULD NOT REPORT - Reassignment in every switch case
// =============================================================================
...
// =============================================================================
// SHOULD REPORT - Pure method (directive misapplied + return is mutable)
// =============================================================================

// OrmWrapper is a wrapper type for testing pure methods.
type OrmWrapper struct{}

// GetDB is a pure-marked method on a wrapper type that returns a new
// *gorm.DB. The directive is unused because the method has no *gorm.DB
// argument to protect.
//
//gormreuse:pure // want `unused gormreuse:pure directive`
...
// =============================================================================
// SHOULD NOT REPORT - Per-step reassignment fix
// =============================================================================
...
// =============================================================================
// SHOULD NOT REPORT - Single chained expression
// =============================================================================
...
func phiOneHasSession(db *gorm.DB, cond bool) {
	...
	if cond {
		...
		q = db.Where("branch2", 2) // Needs Session
	}
...
func phiThreeBranchesMiddleImmutable(db *gorm.DB, mode int) {
	var q *gorm.DB
	if mode == 1 {
		q = db.Where("branch1", 1) // Needs Session
	} else if mode == 2 {
		q = db.Where("branch2", 2).Session(&gorm.Session{}) // Already immutable
	} else {
		q = db.Where("branch3", 3) // Needs Session
	}
...
func phiSwitchMixedSession(db *gorm.DB, mode int) {
	...
	switch mode {
	case 1:
		q = db.Where("case1", 1) // Needs Session
	case 2:
		q = db.Where("case2", 2).Session(&gorm.Session{}) // Already immutable
	case 3:
		q = db.Where("case3", 3) // Needs Session
	default:
		q = db.Where("default") // Needs Session
	}
...
// =============================================================================
// SHOULD NOT REPORT - Phi where every edge is immutable
// =============================================================================
...
// =============================================================================
// SHOULD REPORT - EVIL PATTERNS - FIX GENERATOR EDGE CASE - Callback wrapper functions
// =============================================================================
