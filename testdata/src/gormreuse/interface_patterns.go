...
// =============================================================================
// SHOULD NOT REPORT - INTERFACE CONVERSION DOES NOT POLLUTE
// =============================================================================

// interfaceConversionThenGormUse: Interface conversion then gorm use.
// Interface conversion doesn't pollute, so the subsequent gorm use is the
// first (and only) branch from q.
...
// q is polluted by Find, but no second gorm method call follows so the
// final interface conversion is harmless on its own.
...
// =============================================================================
// SHOULD REPORT - INTERFACE CONVERSION DOES NOT MASK PRIOR POLLUTION
// =============================================================================

// gormUseThenInterfaceConversionThenGormUse: Use, convert, use again.
// The middle interface conversion does not "reset" q — the second gorm
// call is still a reuse of the polluted root.
