...
// =============================================================================
// SHOULD REPORT - Misapplied pure directive (no *gorm.DB argument)
// =============================================================================

// PV109: Pure function without *gorm.DB argument — directive itself is unused.
//
...
// =============================================================================
// SHOULD NOT REPORT - Valid pure functions (continued)
// =============================================================================
...
// =============================================================================
// SHOULD REPORT - Pure function violates its contract by polluting *gorm.DB
// =============================================================================

// PV205: Pure function pollutes the parameter on a conditional path.
//
//gormreuse:pure
...
// =============================================================================
// SHOULD REPORT - Pure function pollutes on one Phi edge
// =============================================================================

// PV209: Pure function with a Phi node where one branch pollutes the
// argument. The pollution is reported on that edge, even though the
// merged return value (mixing Clean and Polluted) is no longer an error.
//
//gormreuse:pure
...
// =============================================================================
// SHOULD NOT REPORT - SSA coverage tests (specific SSA node types)
// =============================================================================
...
// The pure helper is called but returns Clean (no deps); the directive
// itself has nothing to validate, so it's reported as unused.
//
//gormreuse:pure // want `unused gormreuse:pure directive`
...
// This should return Clean in the "no *gorm.DB args" branch — and the
// pure directive is unused because there's no *gorm.DB argument to protect.
//
//gormreuse:pure // want `unused gormreuse:pure directive`
...
// =============================================================================
// SHOULD NOT REPORT - SSA coverage tests (continued)
// =============================================================================
...
// =============================================================================
// SHOULD REPORT - Pure function pollutes *gorm.DB argument
// =============================================================================

// PV233: Tests inferPureUserFuncCall IsPolluted() branch.
// The argument to the inner pure function is Polluted (db.Where result);
// "returns Polluted" is no longer an error — pure only checks argument
// pollution, which is what the want diagnostic captures here.
//
//gormreuse:pure
...
// =============================================================================
// SHOULD NOT REPORT - HELPER FUNCTIONS (not marked as pure)
// =============================================================================
...
// =============================================================================
// SHOULD REPORT - Misapplied pure directive on helper (no *gorm.DB)
// =============================================================================

// pureNoGormArgHelper is a pure-marked helper with no *gorm.DB args, so
// the directive is unused — it has nothing to constrain.
//
//gormreuse:pure // want `unused gormreuse:pure directive`
...
// =============================================================================
// SHOULD NOT REPORT - HELPER FUNCTIONS (continued)
// =============================================================================
